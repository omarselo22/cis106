...
* Video: https://youtu.be/8Sa52S527Qci
...
**I picked a distribution that is not ready yet named Serene Linux. It is a lightweight Ubuntu-based OS from Japan. This distro is providing a comfortable work environment on terminals with low spec. Therefore, it is suitable for old devices. Also, it is easy to use which makes it great for beginners. Additionally, it has a beautiful design. Home page: https://fascode.net/en/projects/linux/serene/**
